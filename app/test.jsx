...
function TestScreen({ go, session, onSubmit }) {
  ...
  const sourceLabel = { daily: "Daily", ai: "AI Generated", pyq: "Previous Year", csr: "CSR Mock", csat: "CSAT Mock" };
  const sourceTone = { daily: "rose", ai: "saffron", pyq: "green", csr: "indigo", csat: "blue" };
